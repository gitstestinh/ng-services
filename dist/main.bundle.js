...
var AddBookComponent = (function () {
    function AddBookComponent(bookService, router) {
    ...
    AddBookComponent.prototype.saveBook = function (formValues) {
        ...
        newBook.bookID = 0;
        this.bookService.addBook(newBook).subscribe(function (data) { return _this.router.navigate(['/dashboard']); }, function (err) { return console.log(err); });
    };
    AddBookComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_app_core_data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */]])
    ], AddBookComponent);
...
var AddReaderComponent = (function () {
    ...
    AddReaderComponent.prototype.saveReader = function (formValues) {
        ...
        this.dataService.addReader(newReader).subscribe(function (data) { return _this.router.navigate(['/dashboard']); }, function (err) { return console.log(err); });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__dashboard_books_resolver__ = __webpack_require__("../../../../../src/app/dashboard/books.resolver.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_4_app_dashboard_dashboard_component__["a" /* DashboardComponent */], resolve: { resolvedBooks: __WEBPACK_IMPORTED_MODULE_7__dashboard_books_resolver__["a" /* BooksResolver */] } },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_app_dashboard_books_resolver__ = __webpack_require__("../../../../../src/app/dashboard/books.resolver.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_app_models_bookTrackerError__ = __webpack_require__("../../../../../src/app/models/bookTrackerError.ts");
...
var DataService = (function () {
    ...
    DataService.prototype.getAllReaders = function () {
        var _this = this;
        return this.http.get('/api/readers', { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Accept': 'application/json',
                'Authorization': 'my-token'
            }) })
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["a" /* catchError */])(function (err) { return _this.handleHttpError(err); }));
    };
    DataService.prototype.getReaderById = function (id) {
        return this.http.get("/api/readers/" + id, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Accept': 'application/json',
                'Authorization': 'my-token'
            }) });
    };
    DataService.prototype.addReader = function (reader) {
        var _this = this;
        return this.http.post("/api/readers", reader, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
    ...
    DataService.prototype.updateReader = function (reader) {
        var _this = this;
        return this.http.put("/api/readers/" + reader.readerID, reader, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Authorization': 'my-token'
            }) })
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["a" /* catchError */])(function (err) { return _this.handleHttpError(err); }));
    ...
    DataService.prototype.deleteReader = function (readerId) {
        var _this = this;
        return this.http.delete("/api/readers/" + readerId, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Authorization': 'my-token'
            }) })
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["a" /* catchError */])(function (err) { return _this.handleHttpError(err); }));
    ...
    DataService.prototype.getBookById = function (id) {
        var _this = this;
        return this.http.get("/api/books/" + id, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Accept': 'application/json',
                'Authorization': 'my-token'
            }) })
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["a" /* catchError */])(function (err) { return _this.handleHttpError(err); }));
    ...
    DataService.prototype.getOldBookById = function (id) {
        ...
        return this.http.get("/api/books/" + id, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
            ...
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["b" /* map */])(function (book) { return ({
            bookTitle: book.title,
            year: book.publicationYear
        }); }), Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["c" /* tap */])(function (value) { return console.log(value); }), Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["a" /* catchError */])(function (err) { return _this.handleHttpError(err); }));
    };
    DataService.prototype.addBook = function (book) {
        var _this = this;
        return this.http.post('/api/books', book, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Authorization': 'my-token'
            }) })
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["a" /* catchError */])(function (err) { return _this.handleHttpError(err); }));
    ...
    DataService.prototype.updateBook = function (book) {
        var _this = this;
        return this.http.put("/api/books/" + book.bookID, book, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Authorization': 'my-token'
            }) })
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["a" /* catchError */])(function (err) { return _this.handleHttpError(err); }));
    ...
    DataService.prototype.deleteBook = function (bookId) {
        var _this = this;
        return this.http.delete("/api/books/" + bookId, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["e" /* HttpHeaders */]({
                'Content-Type': 'application/json',
                'Authorization': 'my-token'
            }) })
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["a" /* catchError */])(function (err) { return _this.handleHttpError(err); }));
    ...
    DataService.prototype.handleHttpError = function (error) {
        var dataError = new __WEBPACK_IMPORTED_MODULE_4_app_models_bookTrackerError__["a" /* BookTrackerError */]();
    ...
    DataService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__logger_service__["a" /* LoggerService */], __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["b" /* HttpClient */]])
    ], DataService);
    return DataService;
}());
...
/***/ "../../../../../src/app/dashboard/books.resolver.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BooksResolver; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
var BooksResolver = (function () {
    function BooksResolver(dataService) {
        this.dataService = dataService;
    }
    BooksResolver.prototype.resolve = function (route, state) {
...
var DashboardComponent = (function () {
    function DashboardComponent(dataService, title, router, activatedRoute) {
        this.dataService = dataService;
        this.title = title;
        this.router = router;
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        var resolvedData = this.activatedRoute.snapshot.data['resolvedBooks'];
        if (resolvedData instanceof __WEBPACK_IMPORTED_MODULE_4_app_models_bookTrackerError__["a" /* BookTrackerError */]) {
            console.log('Error');
        }
        else {
            this.allBooks = resolvedData;
        }
        this.dataService.getAllReaders().subscribe(function (data) { return _this.allReaders = data; }, function (err) { return console.log(err.friendlyMessage); });
...
var EditBookComponent = (function () {
    function EditBookComponent(route, dataService, router) {
        this.route = route;
        this.dataService = dataService;
        this.router = router;
    }
    ...
    EditBookComponent.prototype.saveChanges = function () {
        var _this = this;
        this.dataService.updateBook(this.selectedBook).subscribe(function (val) { return _this.router.navigate(['/dashboard']); }, function (err) { return console.log(err); });
    };
...
var EditReaderComponent = (function () {
    ...
    EditReaderComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getReaderById(readerID).subscribe(function (data) { return _this.selectedReader = data; }, function (err) { return console.log(err); });
        this.currentBadge = this.badgeService.getReaderBadge(this.selectedReader.totalMinutesRead);
    };
    EditReaderComponent.prototype.saveChanges = function () {
        var _this = this;
        this.dataService.updateReader(this.selectedReader).subscribe(function (val) { return _this.router.navigate(['/dashboard']); }, function (err) { return console.log(err); });
    };
